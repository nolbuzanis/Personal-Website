    ...
    <div className='portfolio-modal displayBlock' id='project-website1'>
      <div className='modal-content'>
        ...
        <div className='container'>
          ...
          <p>
            After becoming inspired by a variety of creative, online portfolios,
            I decided to learn HTML, CSS, and JavaScript to create my first
            online portfolio, a static website. This project is hosted by GitHub
            Pages and uses Jekyll to replicate modular elements of this website
            such as individual project pages.
          </p>
          <ul className='project-links'>
            <li>
              <a href='http://www.nolanbuzanis.com/index.html'>
            ...
            <li>
              <a href='https://github.com/nolbuzanis/nolanbuzanis.com'>
                <svg
                  id='Layer_1'
                  height='512px'
